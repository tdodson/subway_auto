...
function story() {
 ...
 // Var ut_en and ut_ja build up the utterance/text by running 'fresh' on each of the arrays and putting concatenating them into a sentence.
...
// Runs the story() function every 8 seconds.
function produce_stories() {
 story();
 setInterval(story, 8000);
}

// Runs produce story on page load.
